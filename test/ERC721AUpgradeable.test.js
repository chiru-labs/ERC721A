...
const createTestSuite = ({ contract, initalizerArgs }) =>
  function () {
    context(`${contract}`, function () {
      beforeEach(async function () {
        ...
        await this.erc721a.initialize(...initalizerArgs);
...
describe('ERC721A', createTestSuite({ contract: 'ERC721AUpgradeableMockInit', initalizerArgs: ['Azuki', 'AZUKI'] }));

describe(
  'ERC721A override _startTokenId()',
  createTestSuite({ contract: 'ERC721AUpgradeableStartTokenIdMock', initalizerArgs: ['Azuki', 'AZUKI', 1] })
);
