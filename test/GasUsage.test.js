...
describe('ERC721A Gas Usage', function () {
  ...
  context('mintOne', function () {
    it('runs mintOne 100 times', async function () {
      for (let i = 0; i < 100; i++) {
  ...
  context('safeMintOne', function () {
    it('runs safeMintOne 100 times', async function () {
      for (let i = 0; i < 100; i++) {
  ...
  context('mintTen', function () {
    it('runs mintTen 100 times', async function () {
      for (let i = 0; i < 100; i++) {
  ...
  context('safeMintTen', function () {
    it('runs safeMintTen 100 times', async function () {
      for (let i = 0; i < 100; i++) {
