...
describe('ERC721ABurnableOwnersExplicitUpgradeable', function () {
  beforeEach(async function () {
    this.ERC721ABurnableOwnersExplicit = await ethers.getContractFactory(
      'ERC721ABurnableOwnersExplicitUpgradeableMock'
    );
    this.token = await this.ERC721ABurnableOwnersExplicit.deploy();
    await this.token.deployed();
    // Initialize
    this.token.initialize('Azuki', 'AZUKI');
  });
