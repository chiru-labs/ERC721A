...
describe('ERC721AOwnersExplicitUpgradeable', function () {
  beforeEach(async function () {
    this.ERC721AOwnersExplicit = await ethers.getContractFactory('ERC721AOwnersExplicitUpgradeableMock');
    this.token = await this.ERC721AOwnersExplicit.deploy();
