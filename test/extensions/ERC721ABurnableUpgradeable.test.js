...
describe('ERC721ABurnableUpgradeable', function () {
  
  beforeEach(async function () {
    this.ERC721ABurnable = await ethers.getContractFactory('ERC721ABurnableUpgradeableMock');
    this.token = await this.ERC721ABurnable.deploy();
